...
def _build_listing_prompt(context: Dict[str, Any]) -> list:
    system = (
        ...
        "Sentence 4: One specific actionable step for the buyer based on what was found.\n\n"
...
def _build_deep_prompt(context: Dict[str, Any]) -> list:
    system = (
        ...
        "response_rate > 80; image_count > 3. Skip positive mention if nothing supports it.\n"
        "Sentence 4: One specific actionable step for the buyer.\n\n"
        "RULES: Use you/your. No markdown. No bullet points. No bold. No headers. "
