-- 0001_initial.sql
-- Snapshot of the v1.0 schema. If your Supabase project was provisioned from
-- an early commit of supabase_schema.sql you may already have all of this;
-- everything below uses "if not exists" guards and is safe to re-run.
-- ===================================================================
-- Run this in the Supabase SQL editor.
-- The `profiles` table already exists â€” do not recreate.
